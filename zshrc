...
#lsd installed for colorful ls output. To make it run do alias ls='lsd'. For more visit -> https://github.com/Peltoche/lsd
#install hack nerd font. To solve issues with icons. If this font is not installed and not set for your terminal you may see quesntion mark icon instead of icons shown on git repo pic
